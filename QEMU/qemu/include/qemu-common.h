 ...
 * shared variables
 */
extern int change_ret;
extern int do_strace;
extern int use_gdb;
extern int with_gdb_exit;
extern int gdb_fd;
extern int gdb_interrupted;
extern int use_cont;
extern int semihosting;
extern int print_ticks;
extern int use_tracer;
extern int use_ctracer;
extern int use_regtracer;
extern int use_memtracer;
extern int only_fixed;
extern int only_floating;
extern int debug;
