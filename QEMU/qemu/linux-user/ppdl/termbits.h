// [TODO] just copy of openrisc, should be reworked
typedef unsigned char   target_ppdl_cc;        /*cc_t*/
typedef unsigned int    target_ppdl_speed;     /*speed_t*/
typedef unsigned int    target_ppdl_tcflag;    /*tcflag_t*/

#define TARGET_NCCS 19
struct target_termios {
    target_ppdl_tcflag c_iflag;               /* input mode flags */
    target_ppdl_tcflag c_oflag;               /* output mode flags */
    target_ppdl_tcflag c_cflag;               /* control mode flags */
    target_ppdl_tcflag c_lflag;               /* local mode flags */
    target_ppdl_cc c_line;                    /* line discipline */
    target_ppdl_cc c_cc[TARGET_NCCS];         /* control characters */
};
...
struct target_termios2 {
    ...
    target_ppdl_cc c_line;                    /* line discipline */
    target_ppdl_cc c_cc[TARGET_NCCS];         /* control characters */
    target_ppdl_speed c_ispeed;               /* input speed */
    target_ppdl_speed c_ospeed;               /* output speed */
};
