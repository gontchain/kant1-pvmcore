...
static uint8_t host_to_target_signal_table[32] = {
    [0] = TARGET_SIGHUP,
    [1] = TARGET_SIGINT,
    [2] = TARGET_SIGQUIT,
    [3] = TARGET_SIGILL,
    ...
    /* Nasty hack: Reverse SIGRTMIN and SIGRTMAX to avoid overlap with
       ...
       To fix this properly we need t*/
    //[__SIGRTMIN] = __SIGRTMAX,
    //[__SIGRTMAX] = __SIGRTMIN,*/
};

static uint8_t target_to_host_signal_table[32];
...
static void setup_sigcontext(struct target_sigcontext *sc,
                            ...
                            unsigned long mask)
{
    qemu_log("setup_sigcontext: not implemented\n");
    return -TARGET_ENOSYS;
}
static inline unsigned long align_sigframe(unsigned long sp)
{
    qemu_log("align_sigframe: not implemented\n");
    return -TARGET_ENOSYS;
}
...
static inline abi_ulong get_sigframe(struct target_sigaction *ka,
                                     ...
                                     size_t frame_size)
{
    qemu_log("get_sigframe: not implemented\n");
    return -TARGET_ENOSYS;
}

static void setup_frame(int sig, struct target_sigaction *ka,
                        target_sigset_t *set, CPUPPDLState *env)
{
    qemu_log("setup_frame: not implemented\n");
    return -TARGET_ENOSYS;
}
...
static void setup_rt_frame(int sig, struct target_sigaction *ka,
                           ...
                           target_sigset_t *set, CPUPPDLState *env)
{
    qemu_log("setup_rt_frame: not implemented\n");
    return -TARGET_ENOSYS;
}

long do_sigreturn(CPUPPDLState *env)
{
...
long do_rt_sigreturn(CPUPPDLState *env)
{
    qemu_log("do_rt_sigreturn: not implemented\n");
    return -TARGET_ENOSYS;
}
