...
#ifdef __CYGWIN__
sigset_t global_mask_sig;
#define PC_sig(context)       0//((context)->uc_mcontext.gregs[REG_RIP])
#define TRAP_sig(context)     0//((context)->uc_mcontext.gregs[REG_TRAPNO])
#define ERROR_sig(context)    0//((context)->uc_mcontext.gregs[REG_ERR])
#define MASK_sig(context)     global_mask_sig//((context)->uc_sigmask)
#else
